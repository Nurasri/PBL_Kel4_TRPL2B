...
return [
    ...
    */
    ...
    | These values override the default values and can be overridden themselves.
    |
    */
    'defines' => [
        /**
         ...
         * Handles slightly malformed HTML better than the built-in php DOMDocument parser.
