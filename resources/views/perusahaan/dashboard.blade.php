    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div class="flex items-center">
                @if($perusahaan->logo)
                    <img src="{{ Storage::url($perusahaan->logo) }}" alt="Logo" class="w-16 h-16 rounded-full object-cover mr-4">
                @else
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <a href="{{ route('laporan-harian.create') }}" 
                   class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 dark:bg-green-900 dark:hover:bg-green-800 transition-colors">
                    <svg class="w-8 h-8 mr-3 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
