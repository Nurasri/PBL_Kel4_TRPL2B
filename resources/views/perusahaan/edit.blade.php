            ...
            <form method="POST" action="{{ route('perusahaan.update', $perusahaan) }}" enctype="multipart/form-data">
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <textarea name="deskripsi" 
                              rows="4" 
                              class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">{{ old('deskripsi', $perusahaan->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <span class="text-xs text-red-600 dark:text-red-400">{{ $message }}</span>
                    @enderror
                </label>
