        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-1">
                    <a href="#home"
                        class="px-4 py-2 bg-[#40916C] rounded-lg transition-all duration-300">Beranda</a>
                    <a href="/tentang-kami"
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-[#18B17C] rounded-full flex items-center justify-center">
                                <i class="fas fa-recycle text-white text-xl"></i>
                            </div>
                            <div>
                                <h4 class="text-lg font-semibold text-[#042A20] mb-2">Reduce (Kurangi)</h4>
                                <p class="text-gray-600">Mengurangi volume limbah dari sumber dengan optimasi proses produksi dan konsumsi yang lebih efisien.</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-[#18B17C] rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Memanfaatkan kembali material dan produk untuk mengurangi kebutuhan sumber daya baru.</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-[#18B17C] rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Mengubah limbah menjadi produk baru melalui proses daur ulang yang ramah lingkungan.</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0 w-12 h-12 bg-[#18B17C] rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Mengambil nilai dari limbah melalui pemulihan energi dan material yang masih bermanfaat.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    <img src="/images/visi_misi.png" alt="Sustainability Vision" class="w-full h-64 object-cover rounded-lg mb-6">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        ...
                        <li class="flex items-center"><i class="fas fa-check text-[#18B17C] mr-2"></i>Efficient waste processing</li>
                        <li class="flex items-center"><i class="fas fa-check text-[#18B17C] mr-2"></i>Circular economy principles</li>
                        <li class="flex items-center"><i class="fas fa-check text-[#18B17C] mr-2"></i>Sustainable resource management</li>
                    </ul>
                </div>
            </div>
