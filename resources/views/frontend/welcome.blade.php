<x-layout>
    ...
    <section class="py-8 container mx-auto px-4">
        <div
            ...
            <!-- Gambar Kanan -->
            <div class="md:w-1/2">
                <img src="assets/img/visi_misi.png" alt="Checklist Ilustrasi" class="w-full rounded-xl object-cover" />
            </div>
        </div>
            ...
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
                ...
                <div class="flex-shrink-0">
                    <div
                        ...
                        <img src="assets/img/people2.jpg" alt="Orang" class="object-cover w-full h-full">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-6 max-w-4xl mx-auto">
                <div class="service-card bg-[#0B4D3C] p-6 rounded-lg">
                    <div class="flex items-start gap-4">
                        <img src="assets/img/unggulan/transformasi.png" alt="" class="w-15 h-15 mt-2">
                        <div>
                ...
                <div class="service-card bg-[#0B4D3C] p-6 rounded-lg">
                    <div class="flex items-start gap-4">
                        <img src="assets/img/unggulan/strategi.png" alt="" class="w-15 h-15">
                        <div>
                ...
                <div class="service-card bg-[#0B4D3C] p-6 rounded-lg">
                    <div class="flex items-start gap-4">
                        <img src="assets/img/unggulan/distrupsi.png" alt="" class="w-15 h-15 mt-2">
                        <div>
                ...
                <div class="service-card bg-[#0B4D3C] p-6 rounded-lg">
                    <div class="flex items-start gap-4">
                        <img src="assets/img/unggulan/citra.png" alt="" class="w-15 h-15 mt-2">
                        <div>
                ...
                <div class="service-card bg-[#0B4D3C] p-6 rounded-lg col-span-2">
                    <div class="flex items-start gap-4">
                        <img src="/img/unggulan/efisiensi.png" alt="" class="w-15 h-15 mt-2">
                        <div>
