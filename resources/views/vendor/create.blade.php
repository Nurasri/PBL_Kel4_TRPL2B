            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <label class="block mt-4 text-sm" for="jenis_layanan">
                    ...
                    <select name="jenis_layanan" id="jenis_layanan"
                        ...
                        <option value="Pengangkutan" {{ old('jenis_layanan') == 'Pengangkutan' ? 'selected' : '' }}>Pengangkutan</option>
                        <option value="Pengolahan" {{ old('jenis_layanan') == 'Pengolahan' ? 'selected' : '' }}>Pengolahan</option>
                        <option value="Daur Ulang" {{ old('jenis_layanan') == 'Daur Ulang' ? 'selected' : '' }}>Daur Ulang</option>
                        <option value="Pembuangan" {{ old('jenis_layanan') == 'Pembuangan' ? 'selected' : '' }}>Pembuangan</option>
                    </select>
                </label>
