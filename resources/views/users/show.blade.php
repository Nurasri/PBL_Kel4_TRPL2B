            ...
            <div class="px-4 py-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <dl class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            <span class="px-2 py-1 text-xs font-semibold leading-tight {{ $user->status === 'active' ? 'text-green-700 bg-green-100 dark:bg-green-700 dark:text-green-100' : 'text-red-700 bg-red-100 dark:bg-red-700 dark:text-red-100' }} rounded-full">
            ...
            <div class="px-4 py-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <dl class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $user->last_login_at ? $user->last_login_at->format('d/m/Y H:i') : '-' }}</dd>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            <span class="px-2 py-1 text-xs font-semibold leading-tight {{ $user->email_verified_at ? 'text-green-700 bg-green-100 dark:bg-green-700 dark:text-green-100' : 'text-red-700 bg-red-100 dark:bg-red-700 dark:text-red-100' }} rounded-full">
